    ...
    <div class="collapse navbar-collapse w-auto" style="height: 100%;" id="sidenav-collapse-main">
        <ul class="navbar-nav" style="height: 100%;">
            ...
            if($this->session->userdata('role') == "Gudang"){
                ?>
                <li class="nav-item">
                    <a class="nav-link <?php if($title == 'Data Bahan Baku') echo 'active'?>" href="<?= base_url('BahanController') ?>">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php if($title == 'Data Bahan Baku') echo 'active'?>" href="<?= base_url('BahanController') ?>">
                        ...
                        <span class="nav-link-text ms-1">Bahan Baku</span>
                        <?= $this->session->userdata('jumlah') > 0 ? 
                        "<span class='badge badge-pill bg-primary' style='margin-left: 25px;'>".$this->session->userdata('jumlah')."</span>" : ""?>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php if($title == 'Data Pengeluaran Bahan Baku') echo 'active'?>" href="<?= base_url('PengeluaranController') ?>">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-fw fa-cart-arrow-down text-warning text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Pengeluaran Bahan Baku</span>
                    </a>
                </li>                
                <li class="nav-item">
