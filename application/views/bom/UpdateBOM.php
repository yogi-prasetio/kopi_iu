        ...
        <div class="col-12">
            <div class="card mb-2">
                <div class="card-header pb-2 mb-2">
                    <span class="h6">Edit BOM</span>
                </div>
                <div class="card-body px-4 pb-3 pt-0">
                    <form method="post" action="<?= base_url('BOMController/Update');?>">
                        <?php foreach($bom as $row) { ?>
                            <input type="hidden" class="form-control" name="id_bom" id="id_bom" placeholder="iD BOM" value="<?= $row->id_bom ?>" required>
                            <div class="form-group row">
                                <label for="nama_bom" class="col-10 col-form-label">Nama BOM</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" name="nama_bom" id="nama_bom" placeholder="Nama BOM" value="<?= $row->nama_bom ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="jumlah" class="col-10 col-form-label">Harga</label>
                                <div class="input-group">
                                    <input type="number" class="form-control" name="harga" id="harga" placeholder="Harga" value="<?= $row->harga ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="LT" class="col-10 col-form-label">Deskripsi</label>
                                <div class="input-group">
                            ...
                            <div class="form-group row">
                                <label for="bahan" class="col-10 col-form-label">Bahan</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10 offset-md-2 text-end">
                                    ...
                                    <input type="submit" class="btn btn-primary mt-4 mb-2" name="btnSimpan" value="Update">
                                </div>
                            </div>
                        <?php } ?>
                    </form>
