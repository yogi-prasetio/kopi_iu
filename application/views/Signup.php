	...
	<main class="main-content  mt-0">
		<section>
			<div class="page-header min-vh-100">
				<div class="container">
					<div class="row">
						<div class="col-6 col-lg-5 col-md-7 d-lg-flex d-none h-100 my-auto pe-0  top-0 start-0 text-center justify-content-center flex-column mx-lg-0 mx-auto">
							<div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style="background-image: url('<?=base_url('assets/img/iu-place.png')?>');
							...
							<div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
								<div class="card card-plain">
									<div class="card-header pb-0 text-start">
										...
										<p class="mb-0">Fill form data to sign up</p>
									</div>
									<div class="card-body">
										<form role="form" action="<?= base_url('Auth/Register') ?>" method="POST">
											<div class="mb-3">
												<input type="text" class="form-control form-control-lg" placeholder="Nama Lengkap" aria-label="FullName" name="fullname" required>
											</div>
											<div class="mb-3">
												<input type="number" class="form-control form-control-lg" placeholder="Nomor Handphone" aria-label="PhoneNumber" name="phoneNumber" required>
											</div>
											<div class="mb-3">
												<textarea  class="form-control form-control-lg" placeholder="Alamat" aria-label="Address" name="address" required></textarea>
											</div>
											<div class="mb-3">
											...
											<div class="text-center mt-3">
	                                            <span>Sudah punya akun? <a href="<?= base_url('Auth/SignIn') ?>" class="text-bold">Masuk</a></span>
	                                        </div>
										</form>
									</div>
								</div>
